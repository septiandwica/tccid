...
<html lang="{{__('language')}}">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('frontend/vendor/swiper/css/swiper-bundle.min.css') }}">
        <link rel="stylesheet" href="{{ asset('frontend/vendor/aos/dist/aos.css') }}">
        <link
            rel="stylesheet"
            href="{{ asset('frontend/vendor/font-awesome/css/all.min.css') }}">
    ...
    <body>
                ...
                <div class="bottom-bar__content">
                    ...
                    <nav class="nav">
                        <ul class="nav__list ">
                            <li class="nav__item ">
                                <a
                                    class="nav__link {{ request()->routeIs('index') ? 'active-menu' : '' }}"
                                    href="{{ route('index') }}">{{__('nav-home')}}</a>
                            </li>
                            <li class="nav__item ">
                                <a
                                    class="nav__link {{ request()->routeIs('product') ? 'active-menu' : '' }}"
                                    href="{{ route('product') }}">{{__('nav-product')}}</a>
                            </li>
                            <li class="nav__item ">
                                <a
                                    class="nav__link {{ request()->routeIs('about') ? 'active-menu' : '' }}"
                                    href="{{ route('about') }}">{{__('nav-about')}}</a>
                            </li>
                            <li class="nav__item ">
                                <a
                                    class="nav__link {{ request()->routeIs('contact') ? 'active-menu' : '' }}"
                                    href="{{ route('contact') }}">{{__('nav-contact')}}</a>
                            </li>
                        </ul>
                    </nav>
                        ...
                        <div class="language-dropdown">
                            ...
                            <label for="toggle" class="dropbtn">
                                <span id="selected-language" class="language-label">
                                    <img
                                        src="{{ asset('frontend/images/lang/' . app()->getLocale() . '.png') }}"
                                        alt="">
                                    {{ __('language') }}
                                </span>
                            </label>
            ...
            <div class="container">
                <div class="row">
                    <div class="col" id="company">
                        <img
                            src="{{ asset('frontend/images/icon/whitelogo.svg') }}"
                            alt="logo"
                            class="logo">
                        <p>
                            Tococo chips indonesia Product
                        </p>
                        <div class="social">
                            <a href="#">
        ...
        window.addEventListener('scroll', function () {
            // Check if the bottom-bar has the class 'scroll'
            if (bottomBar.classList.contains('scrolled')) {
                // Change the source of the img element
                logoImg.src = '{{ asset("frontend/images/icon/greenlogo.svg") }}'; // Replace 'new-source-for-scroll.jpg' with your desired image source
            } else {
                // Reset the source to the original when the class is not present
                logoImg.src = '{{ asset("frontend/images/icon/whitelogo.svg") }}'; // Replace 'original-source.jpg' with your original image source
            }
        });
    });
            ...
            // Fungsi untuk menunjukkan loader
            function showLoader() {
            ...
            function hideLoader() {
                ...
                return new Promise(resolve => {
                    setTimeout(() => {
                        ...
                        resolve();
                    }, 300); // Atur timeout sesuai dengan durasi animasi CSS
                });
            }

            // Event listener untuk mendeteksi perubahan halaman
            ...
            // Event listener untuk mendeteksi perubahan halaman dengan menggunakan popstate
